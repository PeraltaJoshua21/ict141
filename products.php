...
<!--here showing results in the table -->
            ...
            <div class="btn-group">
            <td>
				<a style="width: 90%" class="btn btn-danger" href="deleteproduct.php?del=<?php echo $menu_id;?>" onclick="return confirm('Are you sure you want to delete this request?');">DELETE&nbsp;
